...
import type { BTreeMap, BTreeSet, Bytes, Null, Option, U256, Vec, bool, u128, u32, u64 } from '@polkadot/types-codec';
...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    rolldown: {
      awaitingCancelResolution: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<BTreeSet<u128>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      ...
      lastUpdateBySequencer: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<u128>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
    ...
    sequencerStaking: {
      activeSequencers: AugmentedQuery<ApiType, () => Observable<Vec<AccountId32>>, []> & QueryableStorageEntry<ApiType, []>;
      currentRound: AugmentedQuery<ApiType, () => Observable<u32>, []> & QueryableStorageEntry<ApiType, []>;
      eligibleToBeSequencers: AugmentedQuery<ApiType, () => Observable<BTreeMap<AccountId32, u32>>, []> & QueryableStorageEntry<ApiType, []>;
      ...
      roundCollators: AugmentedQuery<ApiType, (arg: u32 | AnyNumber | Uint8Array) => Observable<Vec<AccountId32>>, [u32]> & QueryableStorageEntry<ApiType, [u32]>;
      selectedSequencer: AugmentedQuery<ApiType, () => Observable<Option<AccountId32>>, []> & QueryableStorageEntry<ApiType, []>;
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<RollupRuntimeSessionKeys>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId32, RollupRuntimeSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
