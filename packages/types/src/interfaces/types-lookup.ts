...
declare module '@polkadot/types/lookup' {
  ...
  interface PalletRolldownError extends Enum {
    ...
    readonly type: 'OperationFailed' | 'ReadRightsExhausted' | 'EmptyUpdate' | 'AddressDeserializationFailure' | 'RequestDoesNotExist' | 'TooManyRequests' | 'InvalidUpdate' | 'WrongRequestId';
  }
