...
declare module '@polkadot/types/lookup' {
  ...
  /** @name OrmlTokensBalanceLock (290) */
  interface OrmlTokensBalanceLock extends Struct {
    readonly id: U8aFixed;
    readonly amount: u128;
  }

  /** @name OrmlTokensAccountData (292) */
  ...
  /** @name OrmlTokensReserveData (294) */
  interface OrmlTokensReserveData extends Struct {
    readonly id: U8aFixed;
    readonly amount: u128;
  }

  /** @name OrmlTokensModuleError (296) */
  ...
  /** @name PalletTransactionPaymentMangataReleases (298) */
  ...
  /** @name PalletProofOfStakeRewardInfo (301) */
  ...
  /** @name PalletProofOfStakePromotedPools (303) */
  interface PalletProofOfStakePromotedPools extends Struct {
    readonly weight: u8;
    readonly rewards: U256;
  }

  /** @name PalletProofOfStakeScheduleRewardsCalculatorScheduleRewards (307) */
  ...
  /** @name PalletProofOfStakeSchedulesList (314) */
  ...
  /** @name PalletProofOfStakeSchedule (317) */
  ...
  /** @name PalletProofOfStakeScheduleRewardsCalculatorActivatedLiquidityPerSchedule (318) */
  ...
  /** @name PalletProofOfStakeError (320) */
  ...
  /** @name PalletFeeLockFeeLockMetadataInfo (321) */
  ...
  /** @name PalletFeeLockAccountFeeLockDataInfo (324) */
  ...
  /** @name PalletVestingMangataReleases (328) */
  ...
  /** @name PalletVestingMangataError (329) */
  ...
  /** @name PalletCrowdloanRewardsRewardInfo (331) */
  ...
  /** @name ParachainStakingSetOrderedSetAccountId32 (358) */
  ...
  /** @name PalletSequencerStakingError (382) */
  ...
  /** @name OrmlAssetRegistryModuleError (395) */
  ...
  /** @name PalletTreasuryProposal (396) */
  ...
  /** @name PalletSudoMangataError (399) */
  interface PalletSudoMangataError extends Enum {
    readonly isRequireSudo: boolean;
    readonly type: 'RequireSudo';
  }

  /** @name PalletSudoOriginError (400) */
  type PalletSudoOriginError = Null;

  /** @name PalletCollectiveMangataVotes (402) */
  ...
  /** @name PalletCollectiveMangataError (403) */
  ...
  /** @name PalletIdentityRegistration (404) */
  ...
  /** @name PalletIdentityRegistrarInfo (412) */
  ...
  /** @name FrameSystemExtensionsCheckTxVersion (418) */
  type FrameSystemExtensionsCheckTxVersion = Null;

  /** @name FrameSystemExtensionsCheckGenesis (419) */
  type FrameSystemExtensionsCheckGenesis = Null;

  /** @name FrameSystemExtensionsCheckNonce (422) */
  interface FrameSystemExtensionsCheckNonce extends Compact<u32> {}

  /** @name FrameSystemExtensionsCheckWeight (423) */
  type FrameSystemExtensionsCheckWeight = Null;

  /** @name PalletTransactionPaymentMangataChargeTransactionPayment (424) */
