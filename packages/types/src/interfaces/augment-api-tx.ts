...
import type { Bytes, Compact, Option, Text, Vec, bool, u128, u16, u32, u64, u8 } from '@polkadot/types-codec';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    rolldown: {
       ...
       **/
      cancelRequestsFromL1: AugmentedSubmittable<(input2: Text | string) => SubmittableExtrinsic<ApiType>, [Text]>;
      /**
       * See [`Pallet::council_update_l2_from_l1`].
       **/
      councilUpdateL2FromL1: AugmentedSubmittable<(inputJson: Text | string) => SubmittableExtrinsic<ApiType>, [Text]>;
      /**
       * See [`Pallet::update_l2_from_l1`].
       **/
      updateL2FromL1: AugmentedSubmittable<(inputJson: Text | string) => SubmittableExtrinsic<ApiType>, [Text]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
