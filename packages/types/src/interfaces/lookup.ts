...
export default {
  ...
  PalletRolldownEvent: {
    _enum: {
      PendingRequestStored: '(AccountId32,H256)'
    }
  },
  /**
  ...
  /**
   * Lookup64: pallet_sequencer_staking::pallet::Event<T>
   **/
  ...
  /**
   * Lookup68: parachain_staking::pallet::DelegationRequest<sp_core::crypto::AccountId32, Balance>
   **/
  ...
  /**
   * Lookup74: staging_xcm::v3::traits::Error
   **/
  ...
  /**
   * Lookup76: pallet_xcm::pallet::Event<T>
   **/
  PalletXcmEvent: {
    _enum: {
      Attempted: {
  ...
  /**
   * Lookup77: staging_xcm::v3::traits::Outcome
   **/
  ...
  /**
   * Lookup78: staging_xcm::v3::multilocation::MultiLocation
   **/
  ...
  /**
   * Lookup79: staging_xcm::v3::junctions::Junctions
   **/
  ...
  /**
   * Lookup80: staging_xcm::v3::junction::Junction
   **/
  ...
  /**
   * Lookup83: staging_xcm::v3::junction::NetworkId
   **/
  ...
  /**
   * Lookup86: staging_xcm::v3::junction::BodyId
   **/
  ...
  /**
   * Lookup87: staging_xcm::v3::junction::BodyPart
   **/
  ...
  /**
   * Lookup88: staging_xcm::v3::Xcm<Call>
   **/
  StagingXcmV3Xcm: 'Vec<StagingXcmV3Instruction>',
  /**
   * Lookup90: staging_xcm::v3::Instruction<Call>
   **/
  ...
  /**
   * Lookup91: staging_xcm::v3::multiasset::MultiAssets
   **/
  StagingXcmV3MultiassetMultiAssets: 'Vec<StagingXcmV3MultiAsset>',
  /**
   * Lookup93: staging_xcm::v3::multiasset::MultiAsset
   **/
  ...
  /**
   * Lookup94: staging_xcm::v3::multiasset::AssetId
   **/
  ...
  /**
   * Lookup95: staging_xcm::v3::multiasset::Fungibility
   **/
  ...
  /**
   * Lookup96: staging_xcm::v3::multiasset::AssetInstance
   **/
  ...
  /**
   * Lookup98: staging_xcm::v3::Response
   **/
  ...
  /**
   * Lookup102: staging_xcm::v3::PalletInfo
   **/
  ...
  /**
   * Lookup105: staging_xcm::v3::MaybeErrorCode
   **/
  ...
  /**
   * Lookup108: staging_xcm::v2::OriginKind
   **/
  StagingXcmV2OriginKind: {
    _enum: ['Native', 'SovereignAccount', 'Superuser', 'Xcm']
  },
  /**
   * Lookup109: staging_xcm::double_encoded::DoubleEncoded<T>
   **/
  StagingXcmDoubleEncoded: {
    encoded: 'Bytes'
  },
  /**
   * Lookup110: staging_xcm::v3::QueryResponseInfo
   **/
  ...
  /**
   * Lookup111: staging_xcm::v3::multiasset::MultiAssetFilter
   **/
  ...
  /**
   * Lookup112: staging_xcm::v3::multiasset::WildMultiAsset
   **/
  ...
  /**
   * Lookup113: staging_xcm::v3::multiasset::WildFungibility
   **/
  StagingXcmV3MultiassetWildFungibility: {
    _enum: ['Fungible', 'NonFungible']
  },
  /**
   * Lookup114: staging_xcm::v3::WeightLimit
   **/
  ...
  /**
   * Lookup115: staging_xcm::VersionedMultiAssets
   **/
  ...
  /**
   * Lookup120: staging_xcm::v2::multilocation::MultiLocation
   **/
  ...
  /**
   * Lookup121: staging_xcm::v2::multilocation::Junctions
   **/
  ...
  /**
   * Lookup122: staging_xcm::v2::junction::Junction
   **/
  ...
  /**
   * Lookup123: staging_xcm::v2::NetworkId
   **/
  ...
  /**
   * Lookup125: staging_xcm::v2::BodyId
   **/
  StagingXcmV2BodyId: {
    _enum: {
      Unit: 'Null',
  ...
  /**
   * Lookup126: staging_xcm::v2::BodyPart
   **/
  ...
  /**
   * Lookup127: staging_xcm::v2::multiasset::Fungibility
   **/
  ...
  /**
   * Lookup128: staging_xcm::v2::multiasset::AssetInstance
   **/
  ...
  /**
   * Lookup129: staging_xcm::VersionedMultiLocation
   **/
  ...
  /**
   * Lookup131: cumulus_pallet_dmp_queue::pallet::Event<T>
   **/
  ...
  /**
   * Lookup133: orml_unknown_tokens::module::Event
   **/
  ...
  /**
   * Lookup134: orml_xcm::module::Event<T>
   **/
  OrmlXcmModuleEvent: {
    _enum: {
      Sent: {
  ...
  /**
   * Lookup135: orml_asset_registry::module::Event<T>
   **/
  ...
  /**
   * Lookup136: orml_traits::asset_registry::AssetMetadata<Balance, mangata_types::assets::CustomMetadata, StringLimit>
   **/
  ...
  /**
   * Lookup137: mangata_types::assets::CustomMetadata
   **/
  ...
  /**
   * Lookup139: mangata_types::assets::XcmMetadata
   **/
  MangataTypesAssetsXcmMetadata: {
    feePerSecond: 'u128'
  },
  /**
   * Lookup141: mangata_types::assets::XykMetadata
   **/
  MangataTypesAssetsXykMetadata: {
    operationsDisabled: 'bool'
  },
  /**
   * Lookup144: pallet_treasury::pallet::Event<T, I>
   **/
  PalletTreasuryEvent: {
    _enum: {
      Proposed: {
  ...
  /**
   * Lookup145: pallet_sudo_mangata::pallet::Event<T>
   **/
  ...
  /**
   * Lookup146: pallet_sudo_origin::pallet::Event<T>
   **/
  ...
  /**
   * Lookup147: pallet_collective_mangata::pallet::Event<T, I>
   **/
  ...
  /**
   * Lookup149: pallet_identity::pallet::Event<T>
   **/
  PalletIdentityEvent: {
    _enum: {
      IdentitySet: {
  ...
  /**
   * Lookup173: cumulus_pallet_parachain_system::unincluded_segment::Ancestor<primitive_types::H256>
   **/
  ...
  /**
   * Lookup174: cumulus_pallet_parachain_system::unincluded_segment::UsedBandwidth
   **/
  ...
  /**
   * Lookup176: cumulus_pallet_parachain_system::unincluded_segment::HrmpChannelUpdate
   **/
  ...
  /**
   * Lookup181: polkadot_primitives::v5::UpgradeGoAhead
   **/
  PolkadotPrimitivesV5UpgradeGoAhead: {
    _enum: ['Abort', 'GoAhead']
  },
  /**
   * Lookup182: cumulus_pallet_parachain_system::unincluded_segment::SegmentTracker<primitive_types::H256>
   **/
  ...
  /**
   * Lookup183: polkadot_primitives::v5::PersistedValidationData<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup186: polkadot_primitives::v5::UpgradeRestriction
   **/
  PolkadotPrimitivesV5UpgradeRestriction: {
    _enum: ['Present']
  },
  /**
   * Lookup187: sp_trie::storage_proof::StorageProof
   **/
  SpTrieStorageProof: {
    trieNodes: 'BTreeSet<Bytes>'
  },
  /**
   * Lookup189: cumulus_pallet_parachain_system::relay_state_snapshot::MessagingStateSnapshot
   **/
  ...
  /**
   * Lookup190: cumulus_pallet_parachain_system::relay_state_snapshot::RelayDispatchQueueRemainingCapacity
   **/
  ...
  /**
   * Lookup193: polkadot_primitives::v5::AbridgedHrmpChannel
   **/
  ...
  /**
   * Lookup194: polkadot_primitives::v5::AbridgedHostConfiguration
   **/
  ...
  /**
   * Lookup195: polkadot_primitives::vstaging::AsyncBackingParams
   **/
  ...
  /**
   * Lookup201: polkadot_core_primitives::OutboundHrmpMessage<polkadot_parachain_primitives::primitives::Id>
   **/
  ...
  /**
   * Lookup202: cumulus_pallet_parachain_system::CodeUpgradeAuthorization<T>
   **/
  ...
  /**
   * Lookup203: cumulus_pallet_parachain_system::pallet::Call<T>
   **/
  ...
  /**
   * Lookup204: cumulus_primitives_parachain_inherent::ParachainInherentData
   **/
  ...
  /**
   * Lookup206: polkadot_core_primitives::InboundDownwardMessage<BlockNumber>
   **/
  ...
  /**
   * Lookup209: polkadot_core_primitives::InboundHrmpMessage<BlockNumber>
   **/
  ...
  /**
   * Lookup212: cumulus_pallet_parachain_system::pallet::Error<T>
   **/
  ...
  /**
   * Lookup214: parachain_info::pallet::Call<T>
   **/
  ParachainInfoCall: 'Null',
  /**
   * Lookup215: pallet_utility_mangata::pallet::Call<T>
   **/
  ...
  /**
   * Lookup222: pallet_maintenance::pallet::Call<T>
   **/
  ...
  /**
   * Lookup223: pallet_rolldown::pallet::Call<T>
   **/
  PalletRolldownCall: {
    _enum: {
      update_l2_from_l1: {
  ...
  /**
   * Lookup224: pallet_rolldown::messages::L1Update
   **/
   ...
   **/
  PalletRolldownError: {
    _enum: ['OperationFailed', 'ReadRightsExhausted', 'EmptyUpdate', 'AddressDeserializationFailure', 'RequestDoesNotExist']
  },
  /**
