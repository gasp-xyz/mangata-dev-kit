...
export default {
  ...
  /**
   * Lookup61: pallet_issuance::TgeInfo<sp_runtime::account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup67: parachain_staking::pallet::DelegationRequest<sp_runtime::account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup138: pallet_maintenance::pallet::Call<T>
   **/
  ...
  /**
   * Lookup139: pallet_rolldown::pallet::Call<T>
   **/
  PalletRolldownCall: {
    _enum: {
      update_l2_from_l1: {
  ...
  /**
   * Lookup140: pallet_rolldown::messages::L1Update
   **/
  ...
  /**
   * Lookup142: pallet_rolldown::messages::Deposit
   **/
  ...
  /**
   * Lookup143: pallet_rolldown::messages::RequestId
   **/
  ...
  /**
   * Lookup144: pallet_rolldown::messages::Origin
   **/
  PalletRolldownMessagesOrigin: {
    _enum: ['L1', 'L2']
  },
  /**
   * Lookup148: pallet_rolldown::messages::CancelResolution
   **/
  ...
  /**
   * Lookup150: pallet_rolldown::messages::WithdrawalResolution
   **/
  ...
  /**
   * Lookup152: pallet_rolldown::messages::L2UpdatesToRemove
   **/
  ...
  /**
   * Lookup154: orml_tokens::module::Call<T>
   **/
  ...
  /**
   * Lookup155: pallet_xyk::pallet::Call<T>
   **/
  PalletXykCall: {
    _enum: {
      create_pool: {
  ...
  /**
   * Lookup190: rollup_runtime::SessionKeys
   **/
  ...
  /**
   * Lookup199: sp_core::ed25519::Signature
   **/
  SpCoreEd25519Signature: '[u8;64]',
  /**
   * Lookup202: finality_grandpa::Equivocation<sp_consensus_grandpa::app::Public, finality_grandpa::Precommit<primitive_types::H256, N>, sp_consensus_grandpa::app::Signature>
   **/
  ...
  /**
   * Lookup203: finality_grandpa::Precommit<primitive_types::H256, N>
   **/
  ...
  /**
   * Lookup205: sp_core::Void
   **/
  SpCoreVoid: 'Null',
  /**
   * Lookup206: orml_asset_registry::module::Call<T>
   **/
  ...
  /**
   * Lookup272: pallet_rolldown::messages::L1
   **/
  PalletRolldownMessagesL1: {
    _enum: ['Ethereum']
  },
  /**
   * Lookup276: pallet_rolldown::pallet::SequencerRights
   **/
  ...
  /**
   * Lookup278: pallet_rolldown::pallet::PendingUpdate<sp_runtime::account::AccountId20>
   **/
  ...
  /**
   * Lookup279: pallet_rolldown::pallet::RequestResult
   **/
  ...
  /**
   * Lookup280: pallet_rolldown::messages::eth_abi::UpdateType
   **/
  ...
  /**
   * Lookup281: pallet_rolldown::pallet::Cancel<sp_runtime::account::AccountId20>
   **/
  ...
  /**
   * Lookup282: pallet_rolldown::pallet::Withdrawal
   **/
  ...
  /**
   * Lookup284: pallet_rolldown::pallet::Error<T>
   **/
  PalletRolldownError: {
  ...
  /**
   * Lookup287: orml_tokens::BalanceLock<Balance>
   **/
  ...
  /**
   * Lookup289: orml_tokens::AccountData<Balance>
   **/
  ...
  /**
   * Lookup291: orml_tokens::ReserveData<ReserveIdentifier, Balance>
   **/
  ...
  /**
   * Lookup293: orml_tokens::module::Error<T>
   **/
  ...
  /**
   * Lookup295: pallet_transaction_payment_mangata::Releases
   **/
  PalletTransactionPaymentMangataReleases: {
    _enum: ['V1Ancient', 'V2']
  },
  /**
   * Lookup297: pallet_xyk::pallet::Error<T>
   **/
  PalletXykError: {
  ...
  /**
   * Lookup298: pallet_proof_of_stake::reward_info::RewardInfo<Balance>
   **/
  ...
  /**
   * Lookup300: pallet_proof_of_stake::pallet::PromotedPools
   **/
  ...
  /**
   * Lookup304: pallet_proof_of_stake::schedule_rewards_calculator::ScheduleRewards<Balance>
   **/
  ...
  /**
   * Lookup311: pallet_proof_of_stake::SchedulesList
   **/
  ...
  /**
   * Lookup314: pallet_proof_of_stake::Schedule<T>
   **/
  ...
  /**
   * Lookup315: pallet_proof_of_stake::schedule_rewards_calculator::ActivatedLiquidityPerSchedule<Balance>
   **/
  ...
  /**
   * Lookup317: pallet_proof_of_stake::pallet::Error<T>
   **/
  ...
  /**
   * Lookup318: pallet_fee_lock::pallet::FeeLockMetadataInfo<T>
   **/
  ...
  /**
   * Lookup321: pallet_fee_lock::pallet::AccountFeeLockDataInfo<BlockNumber, Balance>
   **/
  ...
  /**
   * Lookup322: pallet_fee_lock::pallet::Error<T>
   **/
  PalletFeeLockError: {
  ...
  /**
   * Lookup325: pallet_vesting_mangata::Releases
   **/
  PalletVestingMangataReleases: {
    _enum: ['V0', 'V1']
  },
  /**
   * Lookup326: pallet_vesting_mangata::pallet::Error<T>
   **/
  ...
  /**
   * Lookup328: pallet_crowdloan_rewards::pallet::RewardInfo<T>
   **/
  ...
  /**
   * Lookup329: pallet_crowdloan_rewards::pallet::Error<T>
   **/
  ...
  /**
   * Lookup331: pallet_issuance::pallet::Error<T>
   **/
  PalletIssuanceError: {
  ...
  /**
   * Lookup332: pallet_multipurpose_liquidity::pallet::ReserveStatusInfo<Balance>
   **/
  ...
  /**
   * Lookup334: pallet_multipurpose_liquidity::pallet::RelockStatusInfo<Balance, BlockNumber>
   **/
  ...
  /**
   * Lookup336: pallet_multipurpose_liquidity::pallet::Error<T>
   **/
  ...
  /**
   * Lookup338: pallet_bootstrap::BootstrapPhase
   **/
  ...
  /**
   * Lookup343: pallet_bootstrap::pallet::Error<T>
   **/
  ...
  /**
   * Lookup344: parachain_staking::pallet::RoundInfo<BlockNumber>
   **/
  ...
  /**
   * Lookup345: parachain_staking::pallet::Delegator<sp_runtime::account::AccountId20, Balance, CurrencyId>
   **/
  ...
  /**
   * Lookup346: parachain_staking::set::OrderedSet<parachain_staking::pallet::Bond<sp_runtime::account::AccountId20, Balance, CurrencyId>>
   **/
  ParachainStakingSetOrderedSetBond: 'Vec<ParachainStakingBond>',
  /**
   * Lookup347: parachain_staking::pallet::Bond<sp_runtime::account::AccountId20, Balance, CurrencyId>
   **/
  ...
  /**
   * Lookup349: parachain_staking::pallet::PendingDelegationRequests<sp_runtime::account::AccountId20, Balance>
   **/
  ParachainStakingPendingDelegationRequests: {
    requests: 'BTreeMap<SpRuntimeAccountAccountId20, ParachainStakingDelegationRequest>'
  },
  /**
   * Lookup353: parachain_staking::pallet::DelegatorStatus
   **/
  ...
  /**
   * Lookup354: parachain_staking::pallet::CollatorCandidate<sp_runtime::account::AccountId20, Balance, CurrencyId>
   **/
  ...
  /**
   * Lookup355: parachain_staking::set::OrderedSet<sp_runtime::account::AccountId20>
   **/
  ParachainStakingSetOrderedSetAccountId20: 'Vec<SpRuntimeAccountAccountId20>',
  /**
   * Lookup357: parachain_staking::pallet::CollatorStatus
   **/
  ...
  /**
   * Lookup358: parachain_staking::pallet::CollatorSnapshot<sp_runtime::account::AccountId20, Balance, CurrencyId>
   **/
  ...
  /**
   * Lookup365: parachain_staking::pallet::AggregatorMetadataType<sp_runtime::account::AccountId20, CurrencyId>
   **/
  ...
  /**
   * Lookup375: parachain_staking::pallet::RoundCollatorRewardInfoType<sp_runtime::account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup376: parachain_staking::pallet::Error<T>
   **/
  ...
  /**
   * Lookup393: pallet_treasury::Proposal<sp_runtime::account::AccountId20, Balance>
   **/
  ...
  /**
   * Lookup399: pallet_collective_mangata::Votes<sp_runtime::account::AccountId20, BlockNumber>
   **/
  ...
  /**
   * Lookup409: pallet_identity::types::RegistrarInfo<Balance, sp_runtime::account::AccountId20>
   **/
